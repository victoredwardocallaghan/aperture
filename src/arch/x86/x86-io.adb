...
package body x86.IO is
   ...
   --
   --
   procedure Inb (Port : Aperture.Word16; Value : out Aperture.Byte) is
   begin
   ...
   --
   --
   procedure Outb (Port : Aperture.Word16; Value : Aperture.Byte) is
   begin
      System.Machine_Code.Asm
         (Template => "outb %0, %1",
   ...
   --
   --
   procedure Outw (Port : Aperture.Word16; Value : Aperture.Word16) is
   begin
      System.Machine_Code.Asm
        (Template => "outw %0, %1",
